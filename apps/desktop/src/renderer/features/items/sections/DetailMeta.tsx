        ...
        <>
          ...
          <dd>
            <select
              ...
              onChange={(e) => saveField('cycle_id', e.target.value || null)}
    ...
    <div className="space-y-1">
      ...
      {open && (
        <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs mt-2">
          <DateField field="due_at" label="Due" />
          <DateField field="scheduled_at" label="Scheduled" />
          <DateField field="start_at" label="Start" />
          {item.created_at && (
            <>
